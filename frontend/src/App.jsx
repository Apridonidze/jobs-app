...
const App = () => {
  ...
  const router = createBrowserRouter([
    ...
    {path: '/', element : hasToken ? <Main /> : <Navigate to='/authentication' />  },//directs user to authentication page when not loggined
    ...
    {path : '/my-account', element : hasToken ? <MyUser /> : <Navigate to='/authentication' />}, //if user doesnot have cookies do not redirect them in this page (add in future)
    {path : '/user-account/:userId', element : hasToken ? <OtherUser /> : <Navigate to='/authentication' />},
