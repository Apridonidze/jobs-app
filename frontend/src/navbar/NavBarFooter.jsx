        ...
        <div className="nav-bar-footer d d-flex justify-content-between">
            ...
            <div className="footer-left">
                {user && (user.role === 'Recruiter' ?
                     <button className="btn" onClick={() => { setToggleApplied(false) ; setTogglePending(false) ; setCreateJobs(true) ; setFindJobs(false), setToggleJobsListings(false)}}>Create Job Offer</button> 
                     : <button className="btn" onClick={() => {setToggleSaved(false); setToggleApplied(false) ; setTogglePending(false) ; setCreateJobs(false) ; setFindJobs(true), setToggleJobsListings(false)}}>Find Job</button>)}
            ...
            <div className="footer-right">
                ...
                {/*add button here to trigger jobs that we sent requestes and waiting for response */}
                {user.role === 'Recruiter' && <button className="btn" onClick={() => {setToggleSaved(false); setToggleApplied(false) ; setTogglePending(true) ; setCreateJobs(false) ; setFindJobs(false), setToggleJobsListings(false)}}>Job Pending</button>}
                </>}
